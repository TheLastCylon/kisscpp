...
kch-\/errstat &retrieves the application error states \\\cline{1-2}
kch-\/errclear &Used to marks an application error state as cleared. \\\cline{1-2}
kch-\/stat &retrieves the application statistics \\\cline{1-2}
\end{TabularC}
...
Here is an example of a bash script one can use for setting an application's log levels from the command line.
